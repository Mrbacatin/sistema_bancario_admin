...
//        Cliente cliente = new Cliente(null, "luiz", "21324654", LocalDate.now(),
  //              "luiz.guimaraes@unincor.edu.br", "4564654897", "389102312749128903");
        ClienteDao clienteDao = new ClienteDao();
//        var clientes = clienteDao.buscarTodosClientes();
//        clientes.forEach(c -> System.out.println("id: " + c.getIdCliente() + " Nome: " + c.getNome() +
//              " Data Nascimento: " + c.getDataNascimento() + " cpf: " + c.getCpf() + " email: " + c.getEmail() +
//              " SenhaHash: " + c.getSenhaHash() + " Telefone: " + c.getTelefone()));
